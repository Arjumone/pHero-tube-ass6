...
const response = await fetch(` https://openapi.programming-hero.com/api/videos/category/${id}`)
    ...
    idData.forEach((singleIdData)=>{
        ...
        <div class="card bg-base-100 shadow-xl ">
                    <figure class="w-full h-[200px] relative rounded-lg"><img class="rounded-lg w-[400px] h-[250px] p-3 " src="${singleIdData.thumbnail}" />
                    ...
                    <h2 class=" mb-2 text-center">${singleIdData.others.views} views</h2>
                  </div>
        `
