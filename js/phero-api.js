    ...
    div.innerHTML = `
        <div class="card bg-base-100 shadow-xl ">
                    ...
                    <img class="rounded-full h-14 w-14 mb-3" src="${
                      singleIdData.authors[0].profile_picture
                    }"/>
                    <div class="">
                    
                    <h1 class="text-xl font-semibold ">${singleIdData.title.slice(
                      0,
                      15
                    )}</h1>
                    ...
                    <h2 class="items-center"> ${
                      singleIdData.authors[0].verified
                    ...
                    <h2 class= "-mt-8 mb-2 lg:mb-1 text-center">${
                      singleIdData.others.views
                    } views</h2>
                  </div>
        `;
